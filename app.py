...
if st.session_state.page == "Home":
    ...
    with col2:
        ...
        st.write("I build things with Python and am currently learning my way through the tech world.")
        st.link_button("GitHub", "https://github.com/Ole-py"); st.image("https://avatars.githubusercontent.com/u/9919?s=200", width = 50)
